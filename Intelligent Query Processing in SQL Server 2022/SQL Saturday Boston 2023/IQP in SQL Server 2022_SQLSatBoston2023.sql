...
-- Time Warp!
ALTER DATABASE WideWorldImportersDW SET COMPATIBILITY_LEVEL = 120; -- SQL Server 2014 (120)
...
-- Note the simpler execution plan!!  IO does not decrease, but speed of query processing improves.
SELECT
	ProductID,
	SUM(OrderQty) AS TotalQTY
FROM dbo.SalesOrderDetail_BIG
