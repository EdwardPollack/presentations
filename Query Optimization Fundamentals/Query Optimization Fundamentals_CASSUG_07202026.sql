...
/*	Performance counters: There are a ton of these. This is a sample of what is available.
	...
	-- Blocking Details, if blocking exists
	SELECT
		*
	...
	AND BLOCKED.blocking_session_id IS NOT NULL;
...
/*	QUERY STORE! Use it - it is VERY helpful as it provides HISTORY. Lots of built-in
	reports that provide instant value. More info here:
...
-- #1: This was a goof. Validate and change OR to AND:
SELECT
	Invoices.InvoiceID,
	Invoices.ContactPersonID,
	Invoices.IsCreditNote,
...
-- #2 This is split into 2 queries and processed separately:
SELECT
	Invoices.InvoiceID,
	Invoices.ContactPersonID,
	Invoices.IsCreditNote,
...
/* Wildcard searches are (by definition) table scans
	Other options:
		Full-Text Search
        Remove the leading % to do prefix-searching instead
        SOUNDEX/DIFFERENCE/EDIT_DISTANCE/JARO_WINKLER_DISTANCE
		N-Grams/Tri-Grams
*/
